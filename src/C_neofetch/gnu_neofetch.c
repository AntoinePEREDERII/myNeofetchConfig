...
int main() {
    ...
    printf("\t /.'  /                     `.   \\     	   \e[1;32m--------------------------------\e[0m\n");
    printf("\t:/   :      _...   ..._      ``   :   	\n");
    printf("\t::   :     /._ .`:'_.._\\.    ||   :    	   \e[1;33mSystème d'exploitation : \e[0;28m%s\n", sys_info.sysname);
    printf("\t::    `\\.\\_ ./  ,`  :    \\ . _.'' .    	   \e[1;33mHôte : \e[0;28m%s\n", host_name);
    printf("\t`:.      /   \\|  -.  \\-. \\_      /     	   \e[1;33mNoyau : \e[0;28m%s\n", kernel_version);
    printf("\t  \\:._ _/  .'   .@)  \\@) ` `\\ ,.'      	   \e[1;33mShell : \e[0;28m%s\n", shell_name);
    printf("\t     _/,--'       .- .\\,-.`--`.        	   \e[1;33mMémoire totale : \e[0;28m%.2f Go\n", memory_info_gb);
    printf("\t       ,'/''     (( \\ `  )             	   \e[1;33mCœurs du processeur : \e[0;28m%d\n", cpu_cores);
    printf("\t        /'/'  \\    `-'  (              	   \e[1;33mCœurs du GPU : \e[0;28m%d\n", gpu_cores);
    printf("\t         '/''  `\\._,-----'             	   \e[1;33mRésolution d'écran : \e[0;28m%s\n", resolution);
    printf("\t          ''/'    .,---'               	   \e[1;33mUptime: \e[0;28m%d jours, %d heures, %d minutes, %d secondes\n", days, hours, minutes, seconds);
    printf("\t           ''/'      ;:                	   \e[1;33mNombre de paquets Homebrew : \e[0;28m%d\n", packageCount);
    printf("\t             ''/''  ''/                	   \e[1;33mEspace disque disponible : \e[0;28m%.2f Go\n", diskSpaceGB);
    printf("\t               ''/''/''                \n");
    printf("\t                 '/'/'                 \n");
    printf("\t                  `;\n\n");
